  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Do tratamento bruto dos microdados até a descoberta de padrões
          estatísticos complexos. Qual etapa do projeto vamos abordar hoje?
        </p>
      </div>
      ...
      >
        {MODULOS.map((modulo) => (
          <div
            ...
            onClick={() =>
              modulo.status === "Ativo" && aoSelecionarModulo(modulo.id)
            }
            onMouseEnter={(e) =>
              modulo.status === "Ativo" &&
          ...
          >
            ...
            <div
              style={{
                ...
                fontWeight: "bold",
                backgroundColor:
                  modulo.status === "Ativo" ? modulo.cor : "#e2e8f0",
