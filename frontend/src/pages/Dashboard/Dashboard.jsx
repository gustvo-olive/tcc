    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          ...
          >
            <span style={{ fontSize: "24px" }}>📈</span> Módulo 2: Análise
            Inferencial
          </h2>
        </div>
        <div
      ...
      >
        ...
        >
          Neste módulo, você aprenderá a investigar os dados do ENEM.
          Começaremos com forte apoio teórico (Scaffolding) e, aos poucos, você
          construirá seus próprios fluxos de análise.
        </p>
      </div>
          ...
          {LICOES_MODULO_2.map((licao) => (
            <div
              ...
              style={{
                ...
                border: licao.isPBL ? "2px solid #3b82f6" : "1px solid #e2e8f0",
              }}
            >
              {licao.isPBL && (
                <div
